...
# This script generates, solves and plots a geometric program, cf. Section 5.2
...
if __name__ == "__main__":
    ...
    np.save('../results/gp_log_outer', p.log_outer)
    np.save('../results/gp_log_inner', p.log_inner)
    np.save('../results/gp_gp', gp)
    ...
    if plots:
        generate_all_plots(p, 'gp', fstar=fstar, xstar=xstar, show=False)
