...
# This script generates, solves and plots a quadratically constrained quadratic program, cf. Section 5.2
...
if __name__ == "__main__":
    ...
    np.save('../results/qcqp_log_outer', p.log_outer)
    np.save('../results/qcqp_log_inner', p.log_inner)
    #np.save('../results/qcqp_qp', qp)
    ...
    if plots:
        generate_all_plots(p, 'qcqp', fstar=fstar, xstar=xstar, show=False)
